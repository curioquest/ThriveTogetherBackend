...
from api.accounts.alchemyModels import Accounts
...
config2 = configobj.ConfigObj('.env')
alembic_db_url = config2['ALEMBIC_DB_URL']
...
config.set_main_option('sqlalchemy.url', str(alembic_db_url))
